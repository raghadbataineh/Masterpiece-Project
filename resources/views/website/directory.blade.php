            ...
            <div class="location">
               ...
               <div class="right_section ">
                  ...
                  <ul class="gradient-icon">
                     ...
                     <li>
                        <svg id="sectionButton" xmlns="http://www.w3.org/2000/svg" height="4em" viewBox="0 0 640 512">
                            <defs>
                    ...
                    <li>
                     <svg id="sectionButton1" xmlns="http://www.w3.org/2000/svg" height="4em" viewBox="0 0 640 512">
                        <defs>
                           <linearGradient id="iconGradient1" x1="0%" y1="0%" x2="100%" y2="100%">
                               <stop offset="0%" style="stop-color: #590f87" />
                               <stop offset="50%" style="stop-color: #ff0076" />
